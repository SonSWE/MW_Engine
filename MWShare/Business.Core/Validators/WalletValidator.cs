...
{
    public class WalletValidator : BaseValidator<MWWallet>
    {
        public WalletValidator() : base()
        {
        }

        public WalletValidator(ValidationAction action) : base(action)
        {
        }

        public WalletValidator(ValidationConfig config) : base(config)
        {
        }

        public WalletValidator(ValidationAction action, string language) : base(action, language)
        {
        }
