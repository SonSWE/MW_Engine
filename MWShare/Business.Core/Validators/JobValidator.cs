...
{
    public class JobValidator : BaseValidator<MWJob>
    {
        public JobValidator() : base()
        {
        }

        public JobValidator(ValidationAction action) : base(action)
        {
        }

        public JobValidator(ValidationConfig config) : base(config)
        {
        }

        public JobValidator(ValidationAction action, string language) : base(action, language)
        {
        }
