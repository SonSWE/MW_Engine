...
{
    public class ContractValidator : BaseValidator<MWContract>
    {
        public ContractValidator() : base()
        {
        }

        public ContractValidator(ValidationAction action) : base(action)
        {
        }

        public ContractValidator(ValidationConfig config) : base(config)
        {
        }

        public ContractValidator(ValidationAction action, string language) : base(action, language)
        {
        }
