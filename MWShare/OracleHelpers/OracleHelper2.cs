...
{
    internal sealed class OracleHelper2 : IOracleHelper
    {
        ...
        private void PrepareCommand(OracleCommand command, IDbConnection connection, IDbTransaction transaction, CommandType commandType, string commandText, OracleParameter[] commandParameters, ref bool mustCloseConnection)
        {
        ...
        private void PrepareBatchCommand(OracleCommand command, IDbConnection connection, IDbTransaction transaction, CommandType commandType, string commandText, int numItem, OracleParameter[] commandParameters, ref bool mustCloseConnection)
        {
        ...
        public int ExecuteBatchNonQuery(string connectionString, CommandType commandType, string commandText, int numItem, params OracleParameter[] commandParameters)
        {
            ...
            try
            {
                ...
                return ExecuteBatchNonQuery(connection, commandType, commandText, numItem, commandParameters);
            }
            finally
            {
        ...
        public int ExecuteBatchNonQuery(IDbConnection connection, CommandType commandType, string commandText, int numItem, params OracleParameter[] commandParameters)
        {
        ...
        public int ExecuteBatchNonQuery(IDbTransaction transaction, CommandType commandType, string commandText, int numItem, params OracleParameter[] commandParameters)
        {
        ...
        public async Task<int> ExecuteBatchNonQueryAsync(string connectionString, CommandType commandType, string commandText, int numItem, CancellationToken token = default)
        {
            return await ExecuteBatchNonQueryAsync(connectionString, commandType, commandText, numItem, null, token);
        }
        public async Task<int> ExecuteBatchNonQueryAsync(string connectionString, CommandType commandType, string commandText, int numItem, OracleParameter[] commandParameters, CancellationToken token = default)
        {
            if ((connectionString == null || connectionString.Length == 0)) throw new ArgumentNullException("connectionString");
            // Create & open a OracleConnection, and dispose of it after we are done
            OracleConnection connection = null;
            try
            {
                ...
                // Call the overload that takes a connection in place of the connection string
                return await ExecuteBatchNonQueryAsync(connection, commandType, commandText, numItem, commandParameters, token);
            }
            finally
            {
                if ((connection != null)) connection.Dispose();
        ...
        public async Task<int> ExecuteBatchNonQueryAsync(IDbConnection connection, CommandType commandType, string commandText, int numItem, CancellationToken token = default)
        {
            return await ExecuteBatchNonQueryAsync(connection, commandType, commandText, numItem, null, token);
        }
        public async Task<int> ExecuteBatchNonQueryAsync(IDbConnection connection, CommandType commandType, string commandText, int numItem, OracleParameter[] commandParameters, CancellationToken token = default)
        {
            ...
            // Finally, execute the command
            retval = await cmd.ExecuteNonQueryAsync(token);
        ...
        public async Task<int> ExecuteBatchNonQueryAsync(IDbTransaction transaction, CommandType commandType, string commandText, int numItem, CancellationToken token = default)
        {
            return await ExecuteBatchNonQueryAsync(transaction, commandType, commandText, numItem, null, token);
        }
        public async Task<int> ExecuteBatchNonQueryAsync(IDbTransaction transaction, CommandType commandType, string commandText, int numItem, OracleParameter[] commandParameters, CancellationToken token = default)
        {
        ...
        // -commandParameters - an array of OracleParamters used to execute the command 
        // Returns: An int representing the number of rows affected by the command 
        public int ExecuteNonQuery(IDbConnection connection, CommandType commandType, string commandText, params OracleParameter[] commandParameters)
        {
        ...
        // -commandParameters - an array of OracleParamters used to execute the command 
        // Returns: An int representing the number of rows affected by the command 
        public int ExecuteNonQuery(IDbTransaction transaction, CommandType commandType, string commandText, params OracleParameter[] commandParameters)
        {
        ...
        /// <returns></returns>
        public async Task<int> ExecuteNonQueryAsync(string connectionString, CommandType commandType, string commandText, CancellationToken token = default)
        {
            // Pass through the call providing null for the set of OracleParameters
            return await ExecuteNonQueryAsync(connectionString, commandType, commandText, null, token);
        }
        /// <summary>
        /// ExecuteNonQueryAsync
        /// </summary>
        ...
        public async Task<int> ExecuteNonQueryAsync(string connectionString, CommandType commandType, string commandText, OracleParameter[] commandParameters, CancellationToken token = default)
        {
            if ((connectionString == null || connectionString.Length == 0)) throw new ArgumentNullException("connectionString");
            // Create & open a OracleConnection, and dispose of it after we are done
            OracleConnection connection = null;
            try
            {
                ...
                // Call the overload that takes a connection in place of the connection string
                return await ExecuteNonQueryAsync(connection, commandType, commandText, commandParameters, token);
            }
            finally
            {
                if ((connection != null)) connection.Dispose();
        ...
        /// <returns></returns>
        public async Task<int> ExecuteNonQueryAsync(IDbConnection connection, CommandType commandType, string commandText, CancellationToken token = default)
        {
            // Pass through the call providing null for the set of OracleParameters

            return await ExecuteNonQueryAsync(connection, commandType, commandText, null, token);
        }
        /// <summary>
        /// ExecuteNonQueryAsync
        /// </summary>
        ...
        /// <returns></returns>
        /// <exception cref="ArgumentNullException"></exception>
        public async Task<int> ExecuteNonQueryAsync(IDbConnection connection, CommandType commandType, string commandText, OracleParameter[] commandParameters, CancellationToken token = default)
        {
        ...
        /// <param name="token"></param>
        /// <returns></returns>
        public async Task<int> ExecuteNonQueryAsync(IDbTransaction transaction, CommandType commandType, string commandText, CancellationToken token = default)
        {
            // Pass through the call providing null for the set of OracleParameters

            return await ExecuteNonQueryAsync(transaction, commandType, commandText, null, token);
        }
        /// <summary>
        /// ExecuteNonQueryAsync
        /// </summary>
        ...
        public async Task<int> ExecuteNonQueryAsync(IDbTransaction transaction, CommandType commandType, string commandText, OracleParameter[] commandParameters, CancellationToken token = default)
        {
        ...
        // -commandParameters - an array of OracleParamters used to execute the command
        // Returns: A dataset containing the resultset generated by the command
        public DataSet ExecuteDataset(IDbConnection connection, CommandType commandType, string commandText, params OracleParameter[] commandParameters)
        {
            if ((connection == null)) throw new ArgumentNullException("connection");
            // Create a command and prepare it for execution
            OracleCommand cmd = new OracleCommand();
            ...
            cmd.InitialLOBFetchSize = 4 * 1024 * 1024; // 1~4KB
            ...
            if (commandType == CommandType.Text)
            {
                ...
                if (reader != null)
                {
                    ...
                    {
                        var dataColumn = new DataColumn(reader.GetName(i), reader.GetFieldType(i));
                        if (string.Equals(reader.GetDataTypeName(i), "Date", StringComparison.OrdinalIgnoreCase))
                        {
                    ...
                    if (reader.HasRows)
                    {
                        reader.FetchSize = 4 * 1024 * 1024; // 2~4MB
                        while (reader.Read())
                        {
            ...
            else
            {
                ...
                if (commandParameters != null && commandParameters.Length > 0)
                {
                    foreach (var oracleParameter in commandParameters)
                    {
                        ...
                        var refCursorValue = (OracleRefCursor)oracleParameter.Value;
                        if (refCursorValue.IsNull == false)
                        {
                            var reader = refCursorValue.GetDataReader();
        ...
        // -commandParameters - an array of OracleParamters used to execute the command
        // Returns: A dataset containing the resultset generated by the command
        public DataSet ExecuteDataset(IDbTransaction transaction, CommandType commandType, string commandText, params OracleParameter[] commandParameters)
        {
            if ((transaction == null)) throw new ArgumentNullException("transaction");
            if ((transaction != null) && (transaction.Connection == null)) throw new ArgumentException("The transaction was rollbacked or commited, please provide an open transaction.", "transaction");
        ...
        public async Task<DataSet> ExecuteDatasetAsync(string connectionString, CommandType commandType, string commandText, CancellationToken token = default)
        {
            return await ExecuteDatasetAsync(connectionString, commandType, commandText, null, token);
        }
        public async Task<DataSet> ExecuteDatasetAsync(string connectionString, CommandType commandType, string commandText, OracleParameter[] commandParameters, CancellationToken token = default)
        {
            if ((connectionString == null || connectionString.Length == 0)) throw new ArgumentNullException("connectionString");
            ...
            try
            {
                ...
                // Call the overload that takes a connection in place of the connection string
                return await ExecuteDatasetAsync(connection, commandType, commandText, commandParameters, token);
            }
            finally
            {
                if ((connection != null)) connection.Dispose();
        ...
        public async Task<DataSet> ExecuteDatasetAsync(IDbConnection connection, CommandType commandType, string commandText, CancellationToken token = default)
        {
            return await ExecuteDatasetAsync(connection, commandType, commandText, null, token);
        }
        public async Task<DataSet> ExecuteDatasetAsync(IDbConnection connection, CommandType commandType, string commandText, OracleParameter[] commandParameters, CancellationToken token = default)
        {
            if ((connection == null)) throw new ArgumentNullException("connection");
            // Create a command and prepare it for execution
            OracleCommand cmd = new OracleCommand();
            ...
            cmd.InitialLOBFetchSize = 4 * 1024 * 1024; // 1~4KB
            cmd.FetchSize = 4 * 1024 * 1024; // 2~4MB
        ...
        public async Task<DataSet> ExecuteDatasetAsync(IDbTransaction transaction, CommandType commandType, string commandText, CancellationToken token = default)
        {
            return await ExecuteDatasetAsync(transaction, commandType, commandText, null, token);
        }

        public async Task<DataSet> ExecuteDatasetAsync(IDbTransaction transaction, CommandType commandType, string commandText, OracleParameter[] commandParameters, CancellationToken token = default)
        {
            if ((transaction == null)) throw new ArgumentNullException("transaction");
            if ((transaction != null) && (transaction.Connection == null)) throw new ArgumentException("The transaction was rollbacked or commited, please provide an open transaction.", "transaction");
        ...
        private OracleDataReader ExecuteReader(IDbConnection connection, IDbTransaction transaction, CommandType commandType, string commandText, OracleParameter[] commandParameters, OracleConnectionOwnership connectionOwnership)
        {
        ...
        public OracleDataReader ExecuteReader(string connectionString, CommandType commandType, string commandText)
        {
            // Pass through the call providing null for the set of OracleParameters
        ...
        // -commandText - the stored procedure name or SQL command 
        // Returns: A OracleDataReader containing the resultset generated by the command 
        public OracleDataReader ExecuteReader(IDbConnection connection, CommandType commandType, string commandText)
        {
        ...
        // -commandParameters - an array of OracleParamters used to execute the command 
        // Returns: A OracleDataReader containing the resultset generated by the command 
        public OracleDataReader ExecuteReader(IDbConnection connection, CommandType commandType, string commandText, params OracleParameter[] commandParameters)
        {
        ...
        // -commandText - the stored procedure name or SQL command 
        // Returns: A OracleDataReader containing the resultset generated by the command 
        public OracleDataReader ExecuteReader(IDbTransaction transaction, CommandType commandType, string commandText)
        {
            // Pass through the call providing null for the set of OracleParameters
        ...
        // -commandParameters - an array of OracleParamters used to execute the command 
        // Returns: A OracleDataReader containing the resultset generated by the command 
        public OracleDataReader ExecuteReader(IDbTransaction transaction, CommandType commandType, string commandText, params OracleParameter[] commandParameters)
        {
            if ((transaction == null)) throw new ArgumentNullException("transaction");
            if ((transaction != null) && (transaction.Connection == null)) throw new ArgumentException("The transaction was rollbacked or commited, please provide an open transaction.", "transaction");
        ...
        // -commandParameters - an array of OracleParamters used to execute the command 
        // Returns: An object containing the value in the 1x1 resultset generated by the command 
        public object ExecuteScalar(IDbConnection connection, CommandType commandType, string commandText, params OracleParameter[] commandParameters)
        {
        ...
        // -commandParameters - an array of OracleParamters used to execute the command 
        // Returns: An object containing the value in the 1x1 resultset generated by the command 
        public object ExecuteScalar(IDbTransaction transaction, CommandType commandType, string commandText, params OracleParameter[] commandParameters)
        {
            if ((transaction == null)) throw new ArgumentNullException("transaction");
            if ((transaction != null) && (transaction.Connection == null)) throw new ArgumentException("The transaction was rollbacked or commited, please provide an open transaction.", "transaction");
        ...
        // by a user defined name (probably the actual table name)
        // -commandParameters: An array of OracleParamters used to execute the command
        public void FillDataset(string connectionString, CommandType commandType, string commandText, DataSet dataSet, string[] tableNames, params OracleParameter[] commandParameters)
        {
        ...
        // by a user defined name (probably the actual table name)
        // -commandParameters: An array of OracleParamters used to execute the command
        public void FillDataset(IDbConnection connection, CommandType commandType, string commandText, DataSet dataSet, string[] tableNames, params OracleParameter[] commandParameters)
        {
        ...
        // by a user defined name (probably the actual table name)
        // -commandParameters: An array of OracleParamters used to execute the command
        public void FillDataset(IDbTransaction transaction, CommandType commandType, string commandText, DataSet dataSet, string[] tableNames, params OracleParameter[] commandParameters)
        {
        ...
        // by a user defined name (probably the actual table name)
        // -commandParameters: An array of OracleParamters used to execute the command
        private void FillDataset(IDbConnection connection, IDbTransaction transaction, CommandType commandType, string commandText, DataSet dataSet, string[] tableNames, params OracleParameter[] commandParameters)
        {
        ...
        public void UpdateDataset(OracleCommand insertCommand, OracleCommand deleteCommand, OracleCommand updateCommand, DataSet dataSet, string tableName)
        {
