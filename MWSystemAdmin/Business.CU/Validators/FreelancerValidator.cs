...
{
    public class FreelancerValidator : BaseValidator<MWFreelancer>
    {
        public FreelancerValidator() : base()
        {
        }

        public FreelancerValidator(ValidationAction action) : base(action)
        {
        }

        public FreelancerValidator(ValidationConfig config) : base(config)
        {
        }

        public FreelancerValidator(ValidationAction action, string language) : base(action, language)
        {
        }
